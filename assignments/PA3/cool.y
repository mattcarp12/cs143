...
%}
    ...
    */
    ...
    let_attr_list:		
    let_attr /* single attribute */
    { $$ = single_Features($1); }
    | let_attr_list ',' let_attr /* several attributes */
    ...
    case
    { $$ = single_Cases($1); }
    | case_list case    /* several formals */
